...
final class NetworkTests: XCTestCase {
    ...
    func test_get_request_with_URL() async {
        ...
        let expectedData = MockReturnData.loadTestData()
        sessionSuccess.nextData = expectedData
        
        guard let url = URL(string: "https://api.placeholder.com/search?searchstring=G&searchtype=Name") else {
    ...
    func test_get_should_return_data() async {
        ...
        let expectedData = MockReturnData.loadTestData()
        sessionSuccess.nextData = expectedData
        let data = try! await httpClientSuccess.getData(url: URL(string: "https://api.placeholder.com/search?searchstring=G&searchtype=Name")!)
    ...
    func test_get_should_return_apiError400() async {
        ...
        do {
            _ = try await httpClientFail400.getData(url: URL(string: "https://api.placeholder.com/search?searchstring=G&searchtype=Name")!)
    ...
    func test_get_should_return_apiError500() async {
        ...
        do {
            _ = try await httpClientFail500.getData(url: URL(string: "https://api.placeholder.com/search?searchstring=G&searchtype=Name")!)
            fatalError("Should produce an error.")
    ...
    func test_with_url_response_nil() async {
        ...
        do {
            _ = try await httpClientNilResponse.getData(url: URL(string: "https://api.placeholder.com/search?searchstring=G&searchtype=Name")!)
            fatalError("Should produce an error.")
